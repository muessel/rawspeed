...
private:
  ...
  void fuji_decode_loop (const struct fuji_compressed_params* common_info, int count, uint64* raw_block_offsets, unsigned *block_sizes);
  void fuji_decode_strip (const struct fuji_compressed_params* info_common, int cur_block, uint64 raw_offset, unsigned dsize);
